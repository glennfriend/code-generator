...
/*
    <<請完成以下工作後, 刪除該區塊的程式>>
        ...
        (2) 請到目標 Models 的 preChangeHook() 建立以下程式碼
            ...
            SearchTable::factory('{$tableName->upperCamel()|substr:6}')->rebuild( $object );

        (3) 搜尋程式碼

            SearchTable::factory('{$tableName->upperCamel()|substr:6}')->find(array(
                'field1' => 'value1',
                'field2' => 'value2',
            ));
 ...
 *
 */
class {$tableName->upperCamel()} extends SearchBase
{
